...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $apiUrl = "https://localhost:4000/api/customer/login/";
...
<!-- HTML Structure for the Customer Login Form -->
<div class="h-[80vh] bg-gray-900 flex flex-col justify-center items-center">
    <div class="w-full max-w-md p-8 space-y-6 bg-gray-800 rounded-lg shadow-lg">
        ...
        <p class="mt-2 text-center text-sm text-gray-500">
            ...
            <a href="../reg/index.php" class="font-medium text-indigo-600 hover:text-indigo-500">
                Register
            </a>
        </p>
    </div>
